C IGRF.FOR — IGRF geomagnetic field model with L-value (SHELLG)
C Based on IGRF_SUB.FOR (D. Bilitza, NSSDC/GSFC) + SHELLIG.FOR
C Modified for UpperAtmPy: added data_root, version selection, bug fixes
C
      module upperatmpy_igrf_data
          implicit none
          character(512) :: data_root = ''
          integer        :: igrf_version = 14
      end module upperatmpy_igrf_data
C
C*********************************************************************
...
C          COMMON 
C               X(3)    NOT USED
C               H(200)  FIELD MODEL COEFFICIENTS ADJUSTED FOR SHELLG
C-----------------------------------------------------------------------
C  OUTPUT: FL           L-VALUE
...
C-----------------------------------------------------------------------
            DIMENSION         V(3),U(3,3),P(8,5000),SP(3)
            COMMON            X(3),H(200)
      COMMON/FIDB0/     SP
      COMMON/GENER/     UMR,ERA,AQUAD,BQUAD
C
...
C-----------------------------------------------------------------------
      ...
      CHARACTER*14      NAME
            COMMON            XI(3),H(200)
            COMMON/MODEL/     NAME,NMAX,TIME,G(200)  
      COMMON/GENER/     UMR,ERA,AQUAD,BQUAD
C
...
C  Modified for UpperAtmPy: supports IGRF-13 and IGRF-14 via module var
C-----------------------------------------------------------------------
        use upperatmpy_igrf_data, only: igrf_version
        CHARACTER*14    FIL1, FIL2
                DIMENSION       GH1(200),GH2(200),GHA(200)
        CHARACTER*14    FILMOD(18)
        DIMENSION       DTEMOD(18)
        DOUBLE PRECISION X,F0,F
        COMMON/MODEL/   FIL1,NMAX,TIME,GH1
        COMMON/GENER/   UMR,ERAD,AQUAD,BQUAD
C
C-- Select coefficient set based on IGRF version
C
        if (igrf_version .eq. 14) then
C         IGRF-14: dgrf1945..dgrf2015, dgrf2020, igrf2025, igrf2025s
          FILMOD( 1)='dgrf1945.dat'
          FILMOD( 2)='dgrf1950.dat'
          FILMOD( 3)='dgrf1955.dat'
          FILMOD( 4)='dgrf1960.dat'
          FILMOD( 5)='dgrf1965.dat'
          FILMOD( 6)='dgrf1970.dat'
          FILMOD( 7)='dgrf1975.dat'
          FILMOD( 8)='dgrf1980.dat'
          FILMOD( 9)='dgrf1985.dat'
          FILMOD(10)='dgrf1990.dat'
          FILMOD(11)='dgrf1995.dat'
          FILMOD(12)='dgrf2000.dat'
          FILMOD(13)='dgrf2005.dat'
          FILMOD(14)='dgrf2010.dat'
          FILMOD(15)='dgrf2015.dat'
          FILMOD(16)='dgrf2020.dat'
          FILMOD(17)='igrf2025.dat'
          FILMOD(18)='igrf2025s.dat'
          DTEMOD( 1)=1945.
          DTEMOD( 2)=1950.
          DTEMOD( 3)=1955.
          DTEMOD( 4)=1960.
...
C         IGRF-13: dgrf1945..dgrf2015, igrf2020, igrf2020s
          FILMOD( 1)='dgrf1945.dat'
          FILMOD( 2)='dgrf1950.dat'
          FILMOD( 3)='dgrf1955.dat'
          FILMOD( 4)='dgrf1960.dat'
          ...
          FILMOD(14)='dgrf2010.dat'
          FILMOD(15)='dgrf2015.dat'
          FILMOD(16)='igrf2020.dat'
          FILMOD(17)='igrf2020s.dat'
          DTEMOD( 1)=1945.
          DTEMOD( 2)=1950.
          DTEMOD( 3)=1955.
          DTEMOD( 4)=1960.
...
C
        ...
        use upperatmpy_igrf_data, only: data_root
